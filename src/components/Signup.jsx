...
function Signup() {
  ...
  const validateForm = () => {
    ...
    if (!formData.phone) {
      ...
      errors.phone = 'Please enter a valid Egyptian phone number starting with 01 (e.g., 01010700701)'
    }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter your phone number (e.g., 01010700701)"
              />
              {fieldErrors.phone && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 appearance-none relative block w-full px-3 py-2 border ${
                  fieldErrors.rePassword ? 'border-red-300' : 'border-gray-300'
                } placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm`}
